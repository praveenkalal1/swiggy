...
public class WaitHelper {
	...
	private WebDriverWait getWait(int timeOutInSeconds, int pollingEveryInMiliSecs){
		
		Log.debug("");
		WebDriverWait wait= new WebDriverWait(driver, timeOutInSeconds);
		wait.pollingEvery(pollingEveryInMiliSecs, TimeUnit.MILLISECONDS);
    ...
    public void waitForElementVisible(WebElement locator, int timeOutInSeconds, int pollingEveryInMiliSecs){
		
		Log.info(locator);
		WebDriverWait wait=  getWait(timeOutInSeconds, pollingEveryInMiliSecs);
